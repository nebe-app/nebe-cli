...
const { getRoot, getUsername, getPassword, setConfig, getConfig, getBin } = require('../utils/configGetters');
...
module.exports = class Create {
	...
	async handle() {
		...
		console.log(chalk.green(`Vytvořen config.json a pushnut první commit`));

		setConfig('newestVisual', `${chosenBrand}/${gitRepoName}`);

		console.log(chalk.green(`Vývoj spustíte příkazem: ${getBin()} dev --newest`));
	}
};
