...
const {getRoot, getUsername, getPassword, getConfig, setConfig, getAppEnvironment} = require('../utils/configGetters');
...
module.exports = class Sync {
	async handle() {
		...
		const url = appEnvironment === 'client'
			? `https://app.imagelance.com/visual/sync`
			: `https://${appEnvironment}.imagelance.com/visual/sync`;

		console.log(chalk.bgGreen(`You can change which templates to synchronize at: ${url}`));
