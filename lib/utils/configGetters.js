...
const getAppEnvironment = function () {
	...
	for (let key in args) {
		...
		let envName = args[key].replace('--env=', '')
...
module.exports = { getAppEnvironment, getRoot, getLastDev, getUsername, getPassword, setConfig, getConfig, getCommand };
